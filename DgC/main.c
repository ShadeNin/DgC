...
void hist(){
	if(historia == 1){//primeira fase
		...
		pause();
		printf("Dev: Aumentarei a inteligencia do monstro e o percurso, se prepare\n\n");
		pause();
		...
		pause();
		printf("Dev:Parabens por se manter firme nessa jornada suas habilidades sao notaveis\n\n");  
		pause();
		...
		pause(); 
		printf("Dev: Parabens voce realmente provou todo seu empenho e talento como um programador\n\n");
		pause();
		...
		printf("Dev: Por nada !\n\n");
		pause(); 
		printf("Player: Agora irei voltar a pegar meus 3 onibus pra ir ao trabalho\n\n");
		pause();
		...
		printf("*Toc Toc Toc*\n\n");
		pause();
		printf("Player: Quem sera?\n\n");
		pause();
		printf("Voce abre a porta\n\n");
		pause();
		printf("Player: Ca? Casseb?\n\n");
		pause();
		printf("Casseb:Ola jovem\n\n");
		pause();
		printf("Player:O que o senhor esta fazendo aqui?\n\n");
		pause();
		printf("Casseb: vim passar aqui pra lhe dizer que os verdadeiros algoritmos sao os amigos que nos fazemos nessa jornada\n\n");
		pause();
		printf("Player: ????\n\n");
		pause();
		...
		printf("Girotto: Opa\n\n");
		pause();
		printf("Player: Voce parece com aquela voz...\n\n");
		pause();
		printf("Girotto: Sim utilizei meus poderes como mago da programacao para lhe tirar daquela fatidica vida\n\n"); 
		pause();
		printf("Girotto: Aproveite e pegue sua Ferrari e va viver sua vida feliz\n\n");  
		pause();
		printf("Player: *Chora de alegria*\n\n");
					...
					switch(escolha){
						...
						case 3:
							...
							if(Nrage != 0){
								rage++;
								Nrage--;
								printf("Sua concentração aumentou!\n");
							}else{
								printf("Voce nao tem nem um sobrando\n");
							}
							sleep(2);
...
void hpbar(){
	...
	//printa as barras quando a função é chamada
	printf("\n\t\t\tPlayer\t\t\t\t\tBoss\n");
	for(i = 0; i < 3; i++){
		printf("\t\t\t");
		for(j = 0; j < 12; j++){
...
//função da sala entre a boss fight e a fase 3
void sala(){
	//declaração
	char sala[10][10];
	char player;
...
//Função para o tutorial do jogo
...
//Função de vitória para o fim do jogo
void vitoria(){
	char tecla;
	int vit;
